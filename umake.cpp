...
int main(int argc, char *argv[])
{
    ...
    /*output depfile*/
    depfile.open("build/depfile");

    /*Output autogenerated file notices*/
    makefile << "#File autogenerated by umake, DO NOT hand edit. Changes will be overwritten" << endl
             << endl;
    depfile << "#File autogenerated by umake, DO NOT hand edit. Changes will be overwritten" << endl
            << endl;
